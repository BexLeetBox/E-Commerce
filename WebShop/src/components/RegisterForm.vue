<template>
    <div id="inputs">
      ...
      <RegistrationFields class="input" label="Name" type="text" />
      <RegistrationFields class="input" label="Email" type="email" />
      <div id="username">
      ...
      <RegistrationFields class="input" label="Phone Number" type="tel" />
